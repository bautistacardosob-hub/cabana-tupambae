...
function AnimalSpreadsheetImport({initialCatalog,close}:{initialCatalog:"genetics"|"criollos";close:()=>void}) {
  ...
  const [breed,setBreed]=useState(initialCatalog==="criollos"?"Criollo":"Aberdeen Angus");
...
{page:"general",key:"brand-pdf",label:"Marca para fichas PDF (opcional)",copy:"Si no cargás una imagen, se usa la Marca de la estancia. Subí PNG, WebP o SVG con fondo transparente.",fallback:"/template-brand.svg"},
