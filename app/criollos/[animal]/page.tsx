...
export default async function AnimalPage({params}:PageProps){const {animal:value}=await params;return <SiteApplication initialScreen="animal" initialAnimalId={animalIdFrom(value)}/>;}
