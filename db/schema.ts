...
export const animals = pgTable("animals", {
  ...
  rp: text("rp").notNull(),
  breed: text("breed").notNull().default("Hereford"),
  ...
  image: text("image").notNull().default("/tupambae-animal-placeholder.svg"),
...
export const auctions = pgTable("auctions", {
  ...
  image: text("image").notNull().default("/tupambae-establishment.jpg"),
